...
class Player:
    def __init__(self):
        ...
        self.fix1 = pg.transform.scale(img1, (35, 35))
        
        img2 = pg.image.load("images/mc_run2.png").convert_alpha()
        self.fix2 = pg.transform.scale(img2, (35, 35))
        
        img = pg.image.load("images/mc_stand.png").convert_alpha()
        self.fix = pg.transform.scale(img, (35, 35))

        img_back1 = pg.image.load("images/mcback/mc_runback_1.png").convert_alpha()
        self.fixb1 = pg.transform.scale(img_back1, (35, 35))
        
        img_back2 = pg.image.load("images/mcback/mc_runback_2.png").convert_alpha()
        self.fixb2 = pg.transform.scale(img_back2, (35, 35))
        
        img_back = pg.image.load("images/mcback/mc_look_back.png").convert_alpha()
        self.fixb = pg.transform.scale(img_back, (35, 35))
    ...
    def move(self, vector):
        if vector[1] <= 0:
            ...
            self.run_images = [self.fixb1, self.fixb, self.fixb2]
